	...
	public void run(){
		try(Socket clientSocket = this.clientSocket){
			BufferedReader reader = new BufferedReader
				...
				DataOutputStream sender = new DataOutputStream(clientSocket);
				String uuid;
				uuid= reader.readLine();
				/*Suponemos que pseudoBD es el Map<String,String> que emula a la BD y que está declarado de forma global*/
				if(pseudoBD.contains(uuid)){
					File file= new File(psudoBD.get(uuid));
