...
public class Launcher {
	...
	public static void main(String[] args) {
		// Page array and map creating code extracted from
		// ClientRequetsTest.java (sic)
		...
		final HybridServer server = new HybridServer(pagesMap);

		System.out.println("-- " + server.getName().toUpperCase() + " --");
		server.start();
