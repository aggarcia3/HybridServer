...
public interface IOBackedWebResourceMap<K, V> extends Closeable {
     ...
     * @throws IOException If some I/O error occurred during the operation
     */
    Set<Map.Entry<K, V>> entrySet() throws IOException;
     ...
     * @throws IOException If some I/O error occurred during the operation
     */
    default V getOrDefault(K key, V defaultValue) throws IOException {
        V v;
     ...
     * @since 1.8
     */
    default void forEach(BiConsumer<? super K, ? super V> action) throws IOException {
     ...
     * @since 1.8
     */
    default void replaceAll(BiFunction<? super K, ? super V, ? extends V> function) throws IOException {
     ...
     * @since 1.8
     */
    default V putIfAbsent(K key, V value) throws IOException {
        V v = get(key);
        if (v == null) {
            v = put(key, value);
        }
     ...
     * @throws IOException If some I/O error occurred during the operation
     */
    default boolean remove(K key, V value) throws IOException {
     ...
     * @since 1.8
     */
    default boolean replace(K key, V oldValue, V newValue) throws IOException {
        Object curValue = get(key);
     ...
     * @since 1.8
     */
    default V replace(K key, V value) throws IOException {
        V curValue;
    ...
    default V computeIfAbsent(K key,
            Function<? super K, ? extends V> mappingFunction) throws IOException {
    ...
    default V computeIfPresent(K key,
            BiFunction<? super K, ? super V, ? extends V> remappingFunction) throws IOException {
    ...
    default V merge(K key, V value,
            BiFunction<? super V, ? super V, ? extends V> remappingFunction) throws IOException {
        Objects.requireNonNull(remappingFunction);
